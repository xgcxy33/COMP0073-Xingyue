...
if __name__ == "__main__":
    ...
    for record in input_file_data:
        res = generate_combined_model_response(image=record["image_path"], args=args)
        print(res)
