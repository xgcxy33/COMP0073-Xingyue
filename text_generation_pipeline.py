...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_model_top_p", type=float, default=0.95)
    parser.add_argument("--image_model_temperature", type=float, default=0.5)
    parser.add_argument("--image_model_seed", default=42)
    parser.add_argument("--image_model_prompt_key", default="default_image_prompt")
    parser.add_argument("--clinic_model_top_p", type=float, default=0.9)
    parser.add_argument("--clinic_model_temperature", type=float, default=0.9)
